package kr.magicbox.auth.domain.enums;

import kr.magicbox.auth.domain.exception.InvalidUserRoleException;
...
public enum UserRole {
    ...
    private static final Map<String, UserRole> NAME_MAP = Arrays.stream(values())
